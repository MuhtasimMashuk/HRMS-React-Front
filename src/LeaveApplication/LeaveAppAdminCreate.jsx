...
function LeaveAppAdminCreate() {

     const[apply, setApply]=useState({appDate:"", fromDate:"", toDate: "", entry:"ADMIN",reason:"",employeeId:"",leaveTypeId:"",onLeaveContactNo:"",responsiblePersonId:"",remarks:"", active: false })
                 ...
                 <div className = "container">
                      <div className = "row">
                          <div className = "card col-md-6 offset-md-3 offset-md-3">
                              <h2 className="text-center">Leave Application from Admin</h2>
...
export default LeaveAppAdminCreate
